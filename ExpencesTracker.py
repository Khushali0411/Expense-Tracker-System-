...
dataentery_frame_bg = '#C6DFF7'
buttons_frame_bg = '#EFF8FF'
hlb_btn_bg = '#ADD8E6'
...
Button(buttons_frame, text='Clear Fields in DataEntry', font=btn_font, width=25, bg=hlb_btn_bg, command=clear_fields).place(x=335, y=5)
